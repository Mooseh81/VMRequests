...
<body>
    ...
    <form id="VMRequestForm" class="pure-form pure-form-aligned" runat="server">
        ...
        <div class="pure-control-group">
            <label>VM Backup Required</label>
            <asp:CheckBox ID="chkBackup" runat="server" ToolTip="Is a backup of the VM required.  SQL Backups are seperate" CssClass="icheckbox_line-blue"/>
        </div>
        <div class="pure-control-group">
